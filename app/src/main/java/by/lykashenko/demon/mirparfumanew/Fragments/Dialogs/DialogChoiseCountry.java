...
public class DialogChoiseCountry extends DialogFragment {

	public interface CloseCountry {
		void onCloseCountry(String count);
	}

	private CloseCountry closeCountry;

	public void registerCountry(CloseCountry closeCountry) {
		this.closeCountry = closeCountry;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final List<Country> listData = new Select().from(Country.class).execute();
...
//					Log.i(LOG_TAG, "position " + i + " checked =>" + list.getCheckedItemPositions().get(i));
				...
				closeCountry.onCloseCountry(count);
				dismiss();
			}
		});
