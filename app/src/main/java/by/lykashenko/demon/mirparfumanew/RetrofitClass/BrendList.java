                ...
                if (response != null) {
                    ...
                    switch (id_load) {
                        ...
                        case 3:
                            ...
                            for (int i = 0; i < response.body().size(); i++) {
                                Year year_min_max = new Year(response.body().get(i).getValue(),true);
                                year_min_max.save();
                            }
                            sendMessage();
                            break;
                        ...
                        case 4:
                            if ((new Select().from(Semeistvo.class).executeSingle()) != null) {
                                new Delete().from(Semeistvo.class).execute();
                            }
                            for (int i = 0; i < response.body().size(); i++) {
                                Semeistvo semeistvo = new Semeistvo(response.body().get(i).getValue(),true);
                                semeistvo.save();
                            }
                            sendMessage();
                            break;
                        ...
                        case 5:
                            if ((new Select().from(Nota.class).executeSingle()) != null) {
                                new Delete().from(Nota.class).execute();
                            }
                            for (int i = 0; i < response.body().size(); i++) {
                                Nota nota = new Nota(response.body().get(i).getValue(),true);
                                nota.save();
                            }
                            sendMessage();
                            break;
