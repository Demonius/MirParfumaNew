...
public class DialogChoiseNota extends DialogFragment {
	public interface CloseNota {
		void onCloseNota(String count);
	}

	private CloseNota closeNota;

	public void registerNota(CloseNota closeNota) {
		this.closeNota = closeNota;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final List<Nota> listData = new Select().from(Nota.class).execute();
