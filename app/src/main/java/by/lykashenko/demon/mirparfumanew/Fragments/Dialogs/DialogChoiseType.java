...
public class DialogChoiseType extends DialogFragment {
    ...
    public interface CloseType {
        void onCloseType(String count);
    }

    private CloseType closeType;

    public void registerType(CloseType closeType) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final List<Type> listData = new Select().from(Type.class).execute();
