...
public class DialogChoiseYear extends DialogFragment {

	public interface CloseYear {
		void onCloseYear(String count);
	}

	private CloseYear closeYear;

	public void registerYear(CloseYear closeYear) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		title.setText(getResources().getString(R.string.choiseYear));

		list = (ListView) v.findViewById(R.id.brenduList);
		ActiveAndroid.beginTransaction();

		final List<Year> listData = new Select().from(Year.class).execute();
